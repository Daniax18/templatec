function setupAutocompleteProduit(inputSelector, hiddenFieldSelector, suggestionListSelector, unite, ajaxUrl) {
                ...
                success: function (data) {
                    ...
                    data.forEach(function (item) {
                        $(suggestionListSelector).append(
                            "<li class='list-group-item' data-id='" + item.id + "' data-un = '"+ item.unite +"'>" + item.nom + "</li>"
                        );
                    });
                },
                error: function () {
